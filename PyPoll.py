...
with open(file_to_save,'w') as txt_file:    
    ...
    for candidate_name in candidate_votes:
        #Retrieve vote count and percentage of the candidate
        votes=candidate_votes[candidate_name]
        vote_percentage=float(votes)/float(total_votes)* 100
        #Print the candidate name, voter count and percentage of votes
       # print(f'{candidate_name}: {vote_percentage:.1f}% 9{votes:,})\n')
